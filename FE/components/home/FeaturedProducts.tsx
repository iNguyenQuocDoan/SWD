  ...
  return (
    <section className="py-12 md:py-16 lg:py-20 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Products Grid - Chiều cao fit với TopProducts */}
            ...
            <div className="lg:col-span-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {products.slice(0, 4).map((product, index) => {
                  // Get image: prefer thumbnailUrl, fallback to platform logo
                  const platform = typeof product.platformId === 'object' ? product.platformId : null;
                  // Try multiple ways to get thumbnailUrl
                  ...
                  // Use thumbnailUrl if it exists and is not empty, otherwise use platform logo
                  let imageUrl: string | undefined = undefined;
                  if (thumbnailUrl && typeof thumbnailUrl === 'string' && thumbnailUrl.trim() !== '') {
                    imageUrl = thumbnailUrl.trim();
                  } else if (platformLogoUrl && typeof platformLogoUrl === 'string' && platformLogoUrl.trim() !== '') {
